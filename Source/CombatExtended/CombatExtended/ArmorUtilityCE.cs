...
namespace CombatExtended
{
    public static class ArmorUtilityCE
    {
        ...
        public const float HPToArmorRate = 0.005f;       // When calculate whether a bullet can penetrate, use this value to generate an armor penetration value per 100 maxHP
